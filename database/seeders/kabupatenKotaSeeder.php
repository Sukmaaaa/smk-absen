...
class kabupatenKotaSeeder extends Seeder
{
    ...
    public function run()
    {
        $kabupatenKotas = [
            ...
            ['name' => 'Kota Kabupaten Lubuklinggau'],
            ['name' => 'Kota Kabupaten Pagar Alam'],
            ['name' => 'Kota Kabupaten Palembang'],
            ['name' => 'Kota Kabupaten Prabumulih'],
            // RIAU
            ...
            ['name' => 'Kabupaten Siak'],
            ['name' => 'Kota Kabupaten Dumai'],
            ['name' => 'Kota Kabupaten Pekanbaru'],
            // KEPULAUAN RIAU
        ...
        foreach ($kabupatenKotas as $kabupatenKota) {
            DB::table('kabupaten_Kotas')->insert($kabupatenKota);
        }
    }
}
