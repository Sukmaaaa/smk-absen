...
@section('content')
        <div class="card">
            <div class="card-body">
                <!-- FORM KOMPETENSI -->
                <form action="{{ route('management.guru.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <x-adminlte-input type="text" name="name" placeholder="Windah" title="Isi nama" required></x-adminlte-input>
                            </div>
                            <div class="col-md-6">
                                <label>Username</label><span class="fw-bold" style="color:red; font-weight: bold">*</span>
                                <x-adminlte-input type="text" name="username" placeholder="brando_windah" title="Isi username" required></x-adminlte-input>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>Password</label><span class="fw-bold" style="color:red; font-weight: bold">*</span>
                                <input class="form-control" id="password" type="password" name="password" placeholder="***************" title="Isi password" required>
