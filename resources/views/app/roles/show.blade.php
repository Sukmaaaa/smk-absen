...
@section('dashboard_url', 'Lihat Peran')
...
<div class="card-body">
    ...
    @foreach($permissions as $key => $permission)
        ...
        <div class="icheck-primary col-md-3">
            <input type="checkbox" name="permission[]" onclick="return false;" id="{{ $permission->name }}" value="{{ $permission->name }}" {{ in_array($permission->name, $rolePermissions) ? 'checked' : '' }}>
